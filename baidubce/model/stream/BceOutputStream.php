...
class BceOutputStream extends BceBaseStream {
    public function write($data) {
        throw new BceRuntimeException("BceOutputStream", "write");
    }

    public function reserve($size) {
        throw new BceRuntimeException("BceOutputStream", "reserve");
    }

    public function readAll() {
        throw new BceRuntimeException("BceOutputStream", "readAll");
    }
} 